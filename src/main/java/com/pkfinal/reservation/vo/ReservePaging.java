package com.pkfinal.reservation.vo;
...
public class ReservePaging {
	...
	public ReservePaging() {
		
	}
	public ReservePaging(int nowPage, int pageCount, int totalCount,
	...
	public AppointVo getPdsPagingInfo() {
		AppointVo vo = new AppointVo();
		...
		prevNowPage = nowPage -1;
		nextNowPage = nowPage +1;
