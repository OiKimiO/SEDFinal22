...
public class pkVo {
	...
	public String toString() {
		return "pkVo [mn_id=" + mn_id + ", mn_name=" + mn_name + ", mn_seq=" + mn_seq + ", mn_gbn=" + mn_gbn
				+ ", mn_url=" + mn_url + "]";
	}
	
	public pkVo(String mn_id, String mn_name, String mn_seq, String mn_gbn, String mn_url) {
