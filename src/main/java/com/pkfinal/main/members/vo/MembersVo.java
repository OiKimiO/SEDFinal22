...
public class MembersVo {
	...
	public String getM_use_del() {
		return m_use_del;
	}
	public void setM_use_del(String m_use_del) {
		this.m_use_del = m_use_del;
	}
	...
	public MembersVo(String m_id, String m_uid, String m_name, String m_pwd, String m_zipcode, String m_city,
			String m_gugun, String m_addr, String m_tel, String m_email, String m_gbn, String c_id, String m_use_del) {
		this.m_id = m_id;
		this.m_uid = m_uid;
		this.m_name = m_name;
		this.m_pwd = m_pwd;
	...
	public String toString() {
		return "MembersVo [m_id=" + m_id + ", m_uid=" + m_uid + ", m_name=" + m_name + ", m_pwd=" + m_pwd
				+ ", m_zipcode=" + m_zipcode + ", m_city=" + m_city + ", m_gugun=" + m_gugun + ", m_addr=" + m_addr
				+ ", m_tel=" + m_tel + ", m_email=" + m_email + ", m_gbn=" + m_gbn + ", c_id=" + c_id + ", m_use_del="
				+ m_use_del + "]";
	}
