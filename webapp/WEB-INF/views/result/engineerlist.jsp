 ...
 <table style="width : 90%; height : 25px; align : center;" > 
	<tr>
		...
		<c:if test="${ showprev eq true }">
			<a href="${page}?nowpage=${prevnowpage}&pagecount=${pagecount}&pagegrpnum=${pagegrpnum-1}&e_name=${e_name}" style="text-decoration: none;">
			...
			<c:forEach var="pagenum" begin="${ startnum }" end="${ endnum }" step="1">
				&nbsp;&nbsp;
					...
					<c:choose>
						...
						<a href="${page}?nowpage=${pagenum}&pagecount=${pagecount}&pagegrpnum=${pagegrpnum}&e_name=${e_name}" style="text-decoration: none;">	
							<b>${ pagenum }</b>
						</a>
						</c:when>					
						<c:otherwise>         			
		...
		<c:if test="${ shownext eq true }">
			<a href="${page}?nowpage=${nextnowpage}&pagecount=${pagecount}&pagegrpnum=${pagegrpnum+1}&e_name=${e_name}" style="text-decoration: none;">
