...
$(function(){
	...
	$("select[name=cate_id]").val("${cate_id}").prop("selected", true);
	$("select[name=c_id]").val("${c_id}").prop("selected", true);
	...
	$('#selctbtn').click(function(){
		location.href="/DetailEngineering?c_id=" + c_id + "&cate_id=" + cate_id + "&nowpage=1&pagegrpnum=1&gubun=0";
	})
